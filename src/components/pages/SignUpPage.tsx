...
import { Mail, Lock, Eye, EyeOff, User, Sparkles, ArrowRight, GitBranch, Globe, Check } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="mt-6 text-2xl font-bold text-foreground" style={{ fontFamily: 'var(--font-display)' }}>Create your account</h1>
        ...
        <Card className="p-6">
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              <input type="checkbox" className="w-4 h-4 rounded border-border bg-muted mt-0.5" />
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          ...
          <a href="/signin" className="text-[#4F46E5] hover:underline">Sign in</a>
        </p>
