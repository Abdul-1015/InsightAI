...
export const ColumnChartWidget: React.FC<WidgetProps> = ({ widget, data, className }) => {
      ...
      <div className="h-48">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={chartData} layout="vertical">
            ...
            <YAxis dataKey={xAxis} type="category" tick={{ fontSize: 12 }} />
            <Tooltip />
            <Bar dataKey={yAxis} fill="#4F46E5" radius={[0, 4, 4, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
